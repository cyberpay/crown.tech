<?php include "./include/header.php"; ?>
    ...
    <main role="main" class="about">
        ...
        <div class="content">
            ...
            <div class="col-4-1 col-3-1-md col-full-width-sm sidebar">
                ...
                <a class="box" href="./how-it-works">
                    <h5>How it works</h5>
                    <p>Token of exchange and a computer program</p>
                    <div class="arrow"></div>
                </a>
            </div>
            ...
            <div class="col-4-3 col-3-2-md col-full-width-sm">
                <div class="col-3-2 col-full-width-md content-top">
                    ...
                    <p class="initial-letter">
                        ...
                        a global payment, messaging and application platform, enabling developers to build complex new economy
                        applications and offering an efficient low transaction cost platform to store value, register ownership
                ...
                <div class="col-full-width content-bottom">
                    ...
                    <div class="light-content">
                        ...
                        <div class="col-3-1 col-2-1-lg col-full-width-xs">
                            ...
                            <p>The Crown DEV team is a mix of guys from all over the world</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        include "./include/values_bottom.php";
        ?>
    </main>
