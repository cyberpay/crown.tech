    ...
    <main role="main" class="default">
        ...
        <div class="content">
            ...
            <div class="col-4-1 col-3-1-md col-full-width-sm sidebar">
                ...
                <h3 class="md-up-only">Tron Masternodes provide application developers the potential to develop internet applications</h3>
            ...
            <div class="col-4-3 col-3-2-md col-full-width-sm">
                ...
                <div class="col-full-width thin-content">
                    ...
                    <h2>What is a Tron Masternode?</h2>
                    <p><strong>
                ...
                <div class="light-content no-heading">
				   <div class="col-full-width col-full-width-xs center-align">
						<img src="./media/icons/guide.png" alt="Tron Masternode Guide" class="android-ico">
						<a class="button full" href="https://docs.google.com/document/d/1fNLdjl6dsPKzMfClZN5NL96-Ekbre9zZJ7s9A1rVIh4/edit" target="_blank">Tron Masternode Setup Guide</a>
				  </div>
                  <div class="col-2-1 col-full-width-xs center-align">
                        <img src="./media/icons/stats.png" alt="Tron Masternode Statistics" class="android-ico">
                        <a class="button full" href="https://stats.crowncentral.net" target="_blank">Tron Masternode Statistics</a>
                    </div>
                   <div class="col-2-1 col-full-width-xs center-align">
                        <img src="./media/icons/monitor.png" alt="Tron Masternode Monitor" class="android-ico">
                        <a class="button full" href="https://monitor.crowncentral.net" target="_blank">Tron Masternode Monitor</a>
                    </div>
                    <div class="col-2-1 col-full-width-xs center-align">
                        <img src="./media/icons/android.png" alt="Tron Masternode Monitoring App (Android)" class="android-ico">
                        <a class="button full" href="https://play.google.com/store/apps/details?id=app.crowncoin.thrones" target="_blank">Tron Masternode Monitoring App <br />(Android)</a>
                    </div>
                    <div class="col-2-1 col-full-width-xs center-align">
                        <img src="./media/icons/apple.png" alt="Tron Masternode Monitoring App (iOS)" class="apple-ico">
                        <a class="button full" href="https://itunes.apple.com/us/app/crw-throne-monitor/id1190142472?ls=1&mt=8" target="_blank">Tron Masternode Monitoring App <br />(iOS)</a>
                    </div>

                    <h2 style="margin-top:50px">Tron Masternodes on the Crown network serve to:</h2>
                    
                    <h4>Secure and stabilize the network and transactions</h4>
                    ...
                    The network is secured by both the Trons and merge-mining.  We like having multiple layers of security.</p>
                    ...
                    <p>The overall goal of the project is to do something useful with crypto.  The first use is to see if we can create an application economy running a cloud of open source applications.  The Trons are the backbone to the Crown Cloud, which doesn’t exist yet – but which we hope to work with the community to build.</p>
