    ...
    <main role="main" class="default">
        ...
        <div class="content">
            ...
            <div class="col-4-1 col-3-1-md col-full-width-sm sidebar">
                <h1 class="small" data-text="Set up a&nbsp;tron">Set up a&nbsp;Tron</h1>

                <?php include "./include/soc-sites.php" ?>

                <h3 class="md-up-only">Trons provide application developers the potential to develop internet applications</h3>
            ...
            <div class="col-4-3 col-3-2-md col-full-width-sm">
                ...
                <div class="light-content no-heading">
				   <div class="col-full-width col-full-width-xs center-align">
						<img src="./media/icons/guide.png" alt="Tron Guide" class="android-ico">
						<a class="button full" href="https://docs.google.com/document/d/1fNLdjl6dsPKzMfClZN5NL96-Ekbre9zZJ7s9A1rVIh4/edit" target="_blank">Tron Setup Guide (temp)</a>
				  </div>
                  <div class="col-2-1 col-full-width-xs center-align">
                        <img src="./media/icons/stats.png" alt="Tron Statistics" class="android-ico">
                        <a class="button full" href="https://stats.crowncentral.net" target="_blank">Tron Statistics</a>
                    </div>
                   <div class="col-2-1 col-full-width-xs center-align">
                        <img src="./media/icons/monitor.png" alt="Tron Monitor" class="android-ico">
                        <a class="button full" href="https://monitor.crowncentral.net" target="_blank">Tron Monitor</a>
                    </div>
                    <div class="col-2-1 col-full-width-xs center-align">
                        <img src="./media/icons/android.png" alt="Tron Monitoring App (Android)" class="android-ico">
                        <a class="button full" href="https://play.google.com/store/apps/details?id=app.crowncoin.thrones" target="_blank">Tron Monitoring App (Android)</a>
                    </div>
                    <div class="col-2-1 col-full-width-xs center-align">
                        <img src="./media/icons/apple.png" alt="Tron Monitoring App (iOS)" class="apple-ico">
                        <a class="button full" href="https://itunes.apple.com/us/app/crw-throne-monitor/id1190142472?ls=1&mt=8" target="_blank">Tron Monitoring App (iOS)</a>
                    </div>

                    <h2 style="margin-top:50px">Trons on the Crown network serve to:</h2>
